package com.example.jdbcwebservice.config;

import com.example.jdbcwebservice.job.TaxSettlementJob;
...
public class CaculatePoints {
    ...
    public CronTriggerFactoryBean cronCaculatePointsTriggerBean() {
        ...
        stFactory.setCronExpression("*/40 * * * * ?");
        return stFactory;
    }
    ...
    public JobDetailFactoryBean caculateJobDetails() {
        ...
        jobDetailFactoryBean.setJobClass(TaxSettlementJob.class);
